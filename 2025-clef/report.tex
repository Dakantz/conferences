...
\section{Friday}
\subsection{ImageCLEF}
\subsubsection{AUEB NLP Group/Archimedes at ImageCLEFmedical Caption 2025}
\begin{itemize}
    \item Class Assignment: Multiple Vote strategy of CNNs with ResNET (Union, Intersection, \dots)
    \item Captioning: Q-Former with query assignment, Cation Gen + medCLIP scoring (retrieval from generated captions)
    \item Explainability: assignment based on ChatGPT-drawn boxes on 
\end{itemize}
\subsubsection{DS4DH Group at ImageCLEFmedical Caption 2025}
\begin{itemize}
